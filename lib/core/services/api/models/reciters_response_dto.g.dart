...
part of 'reciters_response_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RecitersResponseDto _$RecitersResponseDtoFromJson(Map<String, dynamic> json) =>
    RecitersResponseDto(
...
Map<String, dynamic> _$RecitersResponseDtoToJson(
        RecitersResponseDto instance) =>
    <String, dynamic>{
